...
public class WeatherRVadapter extends RecyclerView.Adapter<WeatherRVadapter.ViewHolder> {
    ...
    public ArrayList<com.cite.newscoopup.WeatherRVmodal> weatherRVmodalArrayList;

    public WeatherRVadapter(ArrayList<com.cite.newscoopup.WeatherRVmodal> weatherRVmodalArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        com.cite.newscoopup.WeatherRVmodal modal = weatherRVmodalArrayList.get(position);
