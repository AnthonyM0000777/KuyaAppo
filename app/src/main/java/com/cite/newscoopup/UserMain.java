...
public class UserMain extends AppCompatActivity implements NewsRVAdapter.NewsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeRL = findViewById (R.id.idRLBSheetUser);
     ...
     /*   addNewsFAB.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View v) {
                Intent i = new Intent (UserMain.this, AddNewsActivity.class);
                startActivity (i);
            }
        });*/
    ...
    private void displayBottomSheet(NewsRVModal newsRVModal) {
        ...
        View layout = LayoutInflater.from (this).inflate (R.layout.userbottom, homeRL);
       ...
       /* editBtn.setOnClickListener (new View.OnClickListener () {
            @Override
            public void onClick(View v) {
                Intent i = new Intent (UserMain.this, EditNewsActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.idEdtUserDashboard:
                startActivity (new Intent (UserMain.this, User_Dashboard.class));
                return true;


            //news headlines
            case R.id.idEdtUserHeadlines:
                startActivity (new Intent (UserMain.this, ApiUser.class));
                return true;
            ...
            case R.id.idEdtUserAbout:
                startActivity (new Intent (UserMain.this, UserAbout.class));
                return true;


            case R.id.idEdtUserLogout:
                Toast.makeText (UserMain.this, "Log out successful", Toast.LENGTH_SHORT).show ();
                mAuth.signOut();
                mGoogleSignInClient.signOut ();
                Intent i = new Intent (UserMain.this, LoginActivity.class);
                startActivity (i);
                this.finish ();
                return true;
            default:
