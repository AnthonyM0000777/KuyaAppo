...
import com.cite.newscoopup.databinding.ActivityRetrieveMapsBinding;
...
public class RetrieveMapsActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance ().getReference("Location List");
        ValueEventListener listener = databaseReference.addValueEventListener (new ValueEventListener () {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Double longitude = snapshot.child ("Latitude").getValue (Double.class);
                Double latitude = snapshot.child("Longitude").getValue (Double.class);
