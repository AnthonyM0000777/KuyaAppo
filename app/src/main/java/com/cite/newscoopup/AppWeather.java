...
public class AppWeather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) && (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED)) {
            ActivityCompat.requestPermissions(AppWeather.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, PERMISSION_CODE);
        }
        ...
        llsearchicon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (city.isEmpty()) {
                    Toast.makeText(AppWeather.this, "Please enter city name!", Toast.LENGTH_SHORT).show();
                } else {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonArray.length() == 0) {
                        tvcityname.setText("");
                        Toast.makeText(AppWeather.this, "Couldn't Find City!", Toast.LENGTH_SHORT).show();
                    } else {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof NetworkError) {
                    ...
                    tvcityname.setText("");
                    Toast.makeText(AppWeather.this, "Enter Valid City Name", Toast.LENGTH_SHORT).show();
                    error.printStackTrace();
                }
            }
        });
